...
serve(async (req) => {
  ...
  console.log(input);
  const configuration = new Configuration({ apiKey: "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" })
  ...
  const prompt = stripIndent`${oneLine`
    You are a representative that is very helpful when it comes to talking about saubhagya! Only ever answer
